...
<!-- MORRIS CHART STYLES-->
<link href="/student/assets/js/morris/morris-0.4.3.min.css"
	rel="stylesheet" />
<!-- CUSTOM STYLES-->
...
<body>
	<div id="wrapper">
		<nav class="navbar navbar-default navbar-cls-top " role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php">在线练习系统</a>
			</div>
			<div
	...
	<!-- JQUERY SCRIPTS -->
	<script src="/student/assets/js/jquery-1.10.2.js"></script>
	<!-- BOOTSTRAP SCRIPTS -->
	<script src="/student/assets/js/bootstrap.min.js"></script>
	<!-- METISMENU SCRIPTS -->
	<script src="/student/assets/js/jquery.metisMenu.js"></script>
	<!-- DATA TABLE SCRIPTS -->
	<script src="/student/assets/js/dataTables/jquery.dataTables.js"></script>
	<script src="/student/assets/js/dataTables/dataTables.bootstrap.js"></script>
	<script>
